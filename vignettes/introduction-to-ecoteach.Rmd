...
- `simple_data`: A simple dataset for demonstration purposes

## Using the Shannon Diversity Function

The package includes a function to calculate Shannon diversity:
...
Here's an example using the simple_data dataset that's included with the package:
